...
import { X, Plus, Bot, MoreHorizontal, Edit2, Trash2 } from 'lucide-react';
...
export const AgentSelectorModal: React.FC<AgentSelectorModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
      {/* モーダルコンテンツ */}
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-7xl h-[calc(100vh-2rem)] flex flex-col overflow-hidden">
        {/* ヘッダー */}
      ...
      {deleteConfirmAgent && (
        <div className="fixed inset-0 bg-black/75 flex items-center justify-center z-60">
          <div className="bg-white rounded-2xl p-6 max-w-sm w-full mx-4 shadow-2xl">
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Agent削除の確認</h3>
            <p className="text-sm text-gray-600 mb-6">
              「{deleteConfirmAgent.name}」を削除しますか？この操作は取り消せません。
            </p>
