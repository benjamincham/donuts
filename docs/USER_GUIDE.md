...
IRos is a powerful AI agent platform built on Amazon Bedrock. This guide introduces the main features and how to use them.
...
The main screen of IRos features a simple and intuitive chat interface.
...
IRos allows you to select, create, and customize AI agents specialized in various domains.
